    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-5xl px-6 py-24 text-center lg:py-32">
          ...
          <h1 className="text-balance text-5xl font-extrabold tracking-tight text-gray-900 sm:text-7xl">
            Track your cargo with confidence.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600 sm:text-xl">
            Welcome to the {tenant?.name || "Partner"} client portal. Manage your truck requests, 
            track real-time shipments, and access your delivery paperwork in one secure place.
          </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid gap-12 sm:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Instant Requests</h3>
                <p className="mt-2 text-gray-600">Request trucks directly from your dashboard and get instant confirmations.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-gray-200">
                ...
                <p className="mt-2 text-gray-600">Monitor your cargo in real-time from dispatch to final delivery.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-gray-200">
                ...
                <p className="mt-2 text-gray-600">Access your historical waybills and invoices securely at any time.</p>
              </div>
            </div>
          </div>
        </div>
