      ...
      <main id="top">
        <section className="relative overflow-hidden border-b border-border/70">
          ...
          <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-20 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center lg:py-28">
            <div>
              <p className="text-[13px] font-medium text-primary">Karigo TMS · Forah Technology</p>
              ...
              <p className="mt-5 max-w-lg text-[17px] leading-relaxed text-muted-foreground">
                Karigo centralizes fleet, dispatch, fuel, engineering, inventory, accounts and gate security into one accountable enterprise environment.
              </p>
