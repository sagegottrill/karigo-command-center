  ...
  return (
    <div className="grid min-h-screen bg-[#ffffff] lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center bg-[#ffffff] w-full h-full">
        {/* Background+Border */}
        <div className="w-[500px] h-[553.13px] border-[1px] border-[#e2e5e9] rounded-[10px] bg-[#ffffff] flex flex-col pt-[23.53px] pb-[24.06px] px-[24px] gap-[24px]">
          
          <div className="flex flex-col gap-[14px] w-full">
            <h1 className="text-[24px] font-[600] leading-[32px] text-[#141a1f] h-[32px]">Internal Portal Sign In</h1>
          ...
          <form className="flex flex-col gap-[24px]" onSubmit={handleLogin}>
            ...
            {/* Select Department */}
            <div className="flex flex-col gap-[12px] w-[449.87px] h-[58px]">
              <label className="text-[14px] font-[500] leading-[14px] text-[#141a1f] h-[14px]">
                Select Department
              </label>
              <div className="flex flex-row items-center justify-between pt-[4.61px] pb-[5.39px] pl-[12.07px] pr-[12.07px] rounded-[4px] border-[1px] border-[#e2e5e9] bg-[#ffffff] w-[450px] h-[32px]">
                <span className="text-[14px] font-[500] leading-[20px] text-[#5c6470]">Select</span>
            ...
            {/* OAuth Buttons & Divider - from Figma outline */}
