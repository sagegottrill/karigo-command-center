    ...
    <>
      ...
      <div className="flex w-full flex-col gap-5 bg-[#F1F2F4] p-[30px] max-md:px-4 max-md:py-5">
        <div className="flex flex-col gap-[5px]">
          <h2 className="text-[24px] font-medium leading-8 text-[#1B2432]">Partner Requests</h2>
        ...
        <div className="w-full overflow-hidden rounded-[10px] border border-[#E2E5E9] bg-white p-5 shadow-[0px_4px_16px_rgba(12,12,13,0.05)]">
          ...
          <div className="hidden grid-cols-[96px_156px_167px_116px_144px_1fr_40px] items-center gap-[30px] border-b border-[#E2E5E9] py-[15px] md:grid">
          ...
          {slice.map((trip) => (
            <div
              key={trip.id}
              className="relative grid grid-cols-[1fr_40px] items-center gap-2 border-b border-[#E2E5E9] py-2.5 md:grid-cols-[96px_156px_167px_116px_144px_1fr_40px] md:gap-[30px]"
            >
