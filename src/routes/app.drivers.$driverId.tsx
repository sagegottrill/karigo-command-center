  ...
  if (!driver) {
    return (
      <EmptyState
        ...
        action={<Button asChild size="sm" variant="outline" className="h-8 text-xs"><Link to="/app/drivers">Back to drivers</Link></Button>}
      />
    );
  }
      ...
      <PageHeader
        ...
        actions={
          <Button asChild size="sm" variant="outline" className="h-8 gap-1.5 text-xs">
            <Link to="/app/drivers"><ArrowLeft className="h-3.5 w-3.5" />All drivers</Link>
          </Button>
        }
      />
